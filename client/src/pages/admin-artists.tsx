...
export default function AdminArtists() {
  ...
  // Fetch artists with proper error handling
  const {
    data: artists = [],
    ...
    enabled: !!localStorage.getItem("admin_token"), // Only run if token exists
            ...
            <CardContent className="pt-6">
              {isLoadingArtists ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-red-600">
                  ...
                  <p>Error loading artists: {artistsError.message}</p>
                  <Button 
                          ...
                          <TableCell>
                            <div className="relative w-16 h-16 shrink-0 rounded-full overflow-hidden border border-gray-200">
                              <Avatar className="w-full h-full">
                                <AvatarImage src={artist.imageUrl ? `${API_BASE_URL}${artist.imageUrl}` : undefined} alt={artist.name} />
                  ...
                  <FormField
                    ...
                    render={({ field }) => {
                      const handleImageChange = (url: string) => {
                        ...
                        field.onChange(url === "" ? undefined : url);
                      };
