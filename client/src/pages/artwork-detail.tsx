...
export default function ArtworkDetail() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 pt-20 font-sans text-gray-800">
      <SeoHead
        title={artwork?.metaTitle || `${artwork?.title} by ${artwork?.artist?.name}` || "Artwork Details"}
        description={artwork?.metaDescription || `${artwork?.title} - ${artwork?.medium}, ${artwork?.dimensions}. Price: $${artwork?.price}` || "View artwork details and purchase"}
        type="article"
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <Badge
                className={`text-base font-semibold px-4 py-1.5 rounded-full shadow-sm ${artwork.availability === "available"
