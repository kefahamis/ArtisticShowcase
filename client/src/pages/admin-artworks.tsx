...
import { insertArtworkSchema, type Artwork, type Artist } from "@shared/schema-old";
          ...
          <div className="flex-1 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent
                  className="sm:max-w-[850px] max-h-[90vh] overflow-y-auto bg-white p-6 rounded-lg shadow-xl z-[100]"
