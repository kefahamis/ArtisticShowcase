            ...
            <div className="hidden lg:flex items-center space-x-8">
              {navigation.map((item) => (
                <Link key={item.name} href={item.href}>
                  <span className={`text-sm font-medium tracking-wide uppercase transition-colors duration-200 hover:text-gray-600 ${
                    isActive(item.href) ? "text-black border-b-2 border-black pb-1" : "text-gray-700"
                  }`}>
                    {item.name}
                  </span>
                </Link>
            ...
            <div className="lg:hidden border-t border-gray-100 py-6">
              <div className="space-y-4">
                {navigation.map((item) => (
                  <Link key={item.name} href={item.href}>
                    <div
                      className={`block py-3 text-sm font-medium tracking-wide uppercase transition-colors duration-200 ${
