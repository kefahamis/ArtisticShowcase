        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-white flex items-center justify-center flex-shrink-0">
                <span className="text-black font-serif text-2xl font-bold">G</span>
              </div>
              <div>
                <h3 className="text-xl font-serif font-light tracking-wide">CONTEMPORARY GALLERY</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <ContactInfoItem icon={<MapPin className="w-5 h-5 text-gray-400 flex-shrink-0" />} text="123 Art District, New York, NY 10001" />
              <ContactInfoItem icon={<Phone className="w-5 h-5 text-gray-400 flex-shrink-0" />} text="+1 (555) 123-4567" />
              <ContactInfoItem icon={<Mail className="w-5 h-5 text-gray-400 flex-shrink-0" />} text="info@contemporarygallery.com" />
            </div>
            <div className="pt-2">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <nav aria-label="Legal and administrative links">
              <ul className="flex flex-wrap justify-center md:justify-end gap-6">
                ...
                <li>
                  <Link href="/admin" className="text-gray-500 hover:text-white text-sm font-light transition-colors duration-200">
                    Admin Login
                  </Link>
                </li>
              </ul>
